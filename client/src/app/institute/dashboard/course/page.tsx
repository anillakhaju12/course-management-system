...
export default function InstituteCourse() {
  ...
  return (
    ...
    <div>
      {isAddCourseBoxOpen && <AddCousrsePopUp closeCreateCousrseBox = {closeCreateCousrseBox} />}
                        ...
                        >
                          ...
                          <td className=" p-5 ">
                            <div className="flex items-center gap-1">
                              ...
                              <button onClick={()=>handleDeleteCourse(course?.courseId)} className="p-2 rounded-full  group transition-all duration-500  flex item-center">
                                <svg
                                  width={20}
                                  height={20}
                                  viewBox="0 0 20 20"

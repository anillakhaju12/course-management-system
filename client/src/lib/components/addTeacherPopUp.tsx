...
import { courseDifficultLevel, IInstituteCourseInputData } from "../store/institute/course/instituteCourseSliceType";
import { createInstituteCourse } from "../store/institute/course/instiuteCourseSlice";
...
export default function AddTeacherPopUp({closeCreateCousrseBox} : {closeCreateCousrseBox : ()=> void;} ){
  ...
  const handleCourseInputData = (e : React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>)=>{
    const {name, value} = e.target
    let fieldValue: string | File | null

    if(name === "courseThumbnail" && e.target instanceof HTMLInputElement){
      fieldValue = e.target.files?.[0] as File
    }else {
      fieldValue = value
    }
  ...
  const handleSubmissionData = (e : React.FormEvent<HTMLFormElement>)=>{
    e.preventDefault()
    dispatch(createInstituteCourse(data))
  }
                ...
                <form onSubmit={handleSubmissionData} className="space-y-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <div className="scale-95">
                      ...
                      <select onChange={handleCourseInputData} name="courseLevel" className="border p-3 shadow-md  border-gray-700 placeholder:text-base focus:outline-none ease-in-out duration-300 rounded-lg w-full">
                    ...
                    <div className="scale-95">
                      ...
                      <select onChange={handleCourseInputData} name="catagoryId" className="border p-3 shadow-md  border-gray-700 placeholder:text-base focus:outline-none ease-in-out duration-300 rounded-lg w-full">
